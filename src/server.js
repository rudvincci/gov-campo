/**
 * Gov Campo — Ierahkwa Sovereign Platform
 * Category: generic | Port: 3242
...
const server = http.createServer(async (req, res) => {
    ...
    if (req.url.startsWith('/api/')) { try { await handleAPI(req, res); } catch(e) { console.error('[gov-campo]', e); json(res, { error: 'Error interno' }, 500); } }
